...
namespace Krs.Ats.IBNet
{
    ...
    public enum OutgoingMessage
    {
        ...
        /// </summary>
        [Description("REQ_POSITIONS")] RequestPositions = 61,
        /// <summary>
        /// Request positions for all accounts
        /// </summary>
        [Description("REQ_ACCOUNT_SUMMARY")] RequestAccountSummary = 62,
        /// <summary>
        /// Cancel Account Summary request
        /// </summary>
        [Description("CANCEL_ACCOUNT_SUMMARY")] CancelAccountSummary = 63,
        /// <summary>
        /// Cancel request of positions for all accounts
        /// </summary>
        [Description("Cancel_POSITIONS")] CancelPositions = 64
    }
}