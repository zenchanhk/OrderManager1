...
public class IBController {
    ...
    public static void load() {
        ...
        // Utils.logToFile(Utils.getBaseDir());
    ...
    private static List<WindowHandler> createWindowHandlers() {
        ...
        windowHandlers.add(new SecurityCodeFailureDialogHandler());
        ...
        windowHandlers.add(new ExcessiveAttempsDialogHandler());
